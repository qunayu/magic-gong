...
var component = _react2.default.createElement('div', null);
...
_reactDom2.default.render(component, document.getElementById('react-root'));
...
var _Answer = __webpack_require__(28);
...
var Home = function (_Component) {
    ...
    function Home(props) {
        ...
        _this.increaseInputWidth = function (e) {
            var input = e.target;
        ...
        _this.keyDown = function (e) {
            if (e.key === 'Enter' && _this.state.input.length > 0) {
                _this.submit();
            }
        };
        ...
        _this.state = {
            wallpaper: 'url(../static/img/' + Math.floor(Math.random() * TOTAL_WALLPAPERS) + '.jpeg)',
            display: false,
            submitted: false,
            input: ""
        };
    ...
    _createClass(Home, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Answer2.default, { display: this.state.display,
...
var BASE_URL = 'https://magic-gong.herokuapp.com/api/answers';
...
var Answer = function (_Component) {
    ...
    function Answer(props) {
        ...
        if (props.display) _this.getAnswers();
        return _this;
    }
    ...
    _createClass(Answer, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (nextProps.input === this.props.input && this.state.answer !== "") return;
